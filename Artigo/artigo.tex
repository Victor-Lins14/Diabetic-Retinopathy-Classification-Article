...
estratificada por classe. Para garantir a reprodutibilidade e a consistência das partições entre todas as arquiteturas avaliadas, foi definida uma \textit{seed} fixa igual a 42. Não foi utilizado um conjunto de teste externo independente.
