...
\usepackage{float} % <--- PACOTE ADICIONADO AQUI PARA TRAVAR AS IMAGENS
...
% ==========================================
% Bloco 1: EfficientNetV2-S (Fixo com [H])
% ==========================================
\begin{figure}[H]
\centering
\includegraphics[width=0.95\columnwidth]{aprendizado.png}
\caption{Curva de aprendizado da loss do EfficientNetV2-S em 512\,px.}
\label{fig:loss_v2}

\vspace{0.3cm}

\includegraphics[width=0.95\columnwidth]{acuracia.png}
\caption{Curva de aprendizado da acurácia do EfficientNetV2-S em 512\,px.}
\label{fig:acc_v2}
\end{figure}

% ==========================================
% Bloco 2: DenseNet169 (Fixo com [H])
% ==========================================
\begin{figure}[H]
\centering
\includegraphics[width=0.95\columnwidth]{aprendizado_densenet.png}
\caption{Curva de aprendizado da loss do DenseNet169.}
\label{fig:loss_dense}

\vspace{0.3cm}

\includegraphics[width=0.95\columnwidth]{acuracia_densenet.png}
\caption{Curva de aprendizado da acurácia do DenseNet169.}
\label{fig:acc_dense}
\end{figure}

% ==========================================
% Bloco 3: ConvNeXt-Small (Fixo com [H])
% ==========================================
\begin{figure}[H]
\centering
\includegraphics[width=0.95\columnwidth]{aprendizado_convnext.png}
\caption{Curva de aprendizado da loss do ConvNeXt-Small.}
\label{fig:loss_convnext}

\vspace{0.3cm}

\includegraphics[width=0.95\columnwidth]{acuracia_convnext.png}
